        ...
        <div className="h-[calc(100vh-12rem)] flex gap-8">
            ...
            <div className="flex-1 flex flex-col glass-premium rounded-[3rem] border border-white/5 relative overflow-hidden">
                ...
                <div className="p-8 pt-4">
                    ...
                    <p className="text-center text-[9px] font-bold uppercase tracking-widest text-foreground-muted/50 mt-3">
                        <Sparkles size={10} className="inline mr-1" />
                        Messages are private and secure • Reviewed by Sabita Subedi
                    </p>
                </div>
            </div>
        </div>
