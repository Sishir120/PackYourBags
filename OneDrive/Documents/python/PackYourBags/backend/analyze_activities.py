...
for dest in destinations:
    ...
    if 'highlights' in dest:
        for highlight in dest['highlights']:
            ...
            elif ('hike' in highlight_lower or 'Hiking' in highlight) and dest not in activities['hiking']:
...
# Detailed breakdown by continent and activity
print("\nDetailed breakdown by continent and activity:")
for continent in all_continents:
    print(f"\n{continent}:")
    for activity, dests in activities.items():
        count = len([d for d in dests if d['continent'] == continent])
