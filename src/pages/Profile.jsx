          ...
          <div className="flex-1 min-w-0">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden">
                  <div className="relative z-10">
                    ...
                    <Link to="/ai-chat" className="inline-flex items-center px-6 py-3 bg-white text-purple-600 rounded-xl font-semibold hover:bg-purple-50 transition-colors">
                      Plan a Trip
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {[1, 2].map((i) => (
                      <div key={i} className="group relative h-48 rounded-xl overflow-hidden cursor-pointer">
                        <img
                          src={`https://source.unsplash.com/random/800x600?travel,${i}`}
                          alt="Destination"
                          className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                        <div className="absolute bottom-4 left-4 text-white">
                          <h4 className="font-bold text-lg">Amazing Destination {i}</h4>
                          <p className="text-sm text-gray-200">Explore now</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            {(activeTab === 'trips' || activeTab === 'favorites') && (
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
                ...
                <Link
                  to={activeTab === 'trips' ? '/ai-chat' : '/destinations'}
