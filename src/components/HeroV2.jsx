        ...
        <section className="relative bg-gradient-to-br from-primary-50 via-white to-primary-50 -mt-20 pt-20 overflow-hidden">
            <div className="container-custom relative z-10">
                <div className="flex flex-col items-center text-center py-20 md:py-32">
                    ...
                    >
                        The gamified AI planner for your next adventure. Perfect for first-timers, couples, and groups exploring destinations worldwide.
                    </motion.p>
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-30">
                <div className="absolute top-20 right-10 w-96 h-96 bg-primary-300 rounded-full mix-blend-multiply filter blur-[60px] opacity-50"></div>
                <div className="absolute bottom-20 left-10 w-96 h-96 bg-amber-200 rounded-full mix-blend-multiply filter blur-[60px] opacity-50"></div>
            </div>
        </section>
    )
}
